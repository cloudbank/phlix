package com.anubis.flickr.listener;
...
public abstract class EndlessScrollListener implements OnScrollListener {
    ...
    public void onScroll(AbsListView view, int firstVisibleItem,
        ...
        //  Log.d("DEBUG", "previousTotalItemCount " + previousTotalItemCount + "totalItemCount "
        // + totalItemCount);
        ...
        //  + firstVisibleItem + ":" + currentPage
        //  + ((firstVisibleItem + visibleThreshold) >= totalItemCount));
        //2:2:0:1
        // the pulltorefresh is creating a bug..there is 1:0:0 at start @todo
        if (totalItemCount > 1 && totalItemCount > visibleItemCount) {
            if (!loading
                    && ((firstVisibleItem + visibleThreshold) >= totalItemCount - visibleItemCount)) {
